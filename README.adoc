...
https://atarazana.github.io/ansible-operator-road-trip-guide/ansible-operator-road-trip-guide/index.html?CLUSTER_SUBDOMAIN=apps-crc.testing&USERNAME=developer&PASSWORD=developer
